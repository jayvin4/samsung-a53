...
function Card5(){
    ...
    <div>
        <div class="bg-white border rounded-3xl">
            <h1 className="text-center pt-6 pb-4 font-bold">Galaxy A33 5G (8GB RAM)</h1>
        <img src="blue4.jpg" alt="Mountain" className="h-84 pl-10 pr-10" />
        <p className="text-center pt-6 text-xs pb-4"><strong>Colour</strong> :Awesome Blue</p>
        ...
        <div className="flex justify-around pl-14 pr-14">
           ...
           <div className="pt-6 pb-6">
            <h1 className="text-center font-bold text-xs">From ₹1696.16/mo for 18 mos Monthly Price:or ₹</h1>
            <h1 className="text-center font-bold text-xs">27499.00</h1>
            <p className="text-center text-xs pt-2"><strike>₹ 34999.00</strike>&nbsp; &nbsp;<a href=" " className="text-cyan-600">Save ₹7500.00</a></p>
           </div>
           
           <div className="text-xs pl-6 pr-6">
            <div className="border-y border-gray-300 flex justify-between">
                <div className="pt-2 pb-2">Water & Dust Resistant</div>
  ...
  <path fill-rule="evenodd" d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.14c.186-.096.446-.24.757-.433.62-.384 1.445-.966 2.274-1.765C15.302 14.988 17 12.493 17 9A7 7 0 103 9c0 3.492 1.698 5.988 3.355 7.584a13.731 13.731 0 002.273 1.765 11.842 11.842 0 00.976.544l.062.029.018.008.006.003zM10 11.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" clip-rule="evenodd" />
            ...
            <div className="border-b border-gray-300 flex justify-between">
                <div className="pt-2 pb-2">FHD+ sAMOLED 90Hz Display</div>
                <div className="py-1.5">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
            ...
            <div className="border-b border-gray-300 flex justify-between">
                <div className="pt-2 pb-2">OIS Camera</div>
                <div className="py-1.5">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5">
